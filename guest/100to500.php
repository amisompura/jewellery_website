...
?>
<!-- Title Page -->
<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/menbanner.jpg);">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                <div class="leftbar p-r-20 p-r-0-sm">
                    ...
                    <ul class="p-b-54">
                        ...
                        <li class="p-t-4">
                            <a href="menring.php" class="s-text13">
                                Rings
                            </a>
                        </li>

                        <li class="p-t-4">
                            <a href="menbraclete.php" class="s-text13">
                                Braclete
                            </a>
                        </li>

                        <li class="p-t-4">
                            <a href="menchain.php" class="s-text13">
                                Chain
                            </a>
                        </li>

                        <li class="p-t-4">
                            <a href="menpendal.php" class="s-text13">
                                Pendals
                            </a>
                        </li>
                    </ul>
                ...
                <div class="flex-sb-m flex-w p-b-35">
                    <div class="flex-w">
                        ...
                        <div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
                            <select class="selection-2" name="sorting">
                                <option>Price</option>
                                <option><a href="1to5.php">₹100.00 - ₹500.00</a></option>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                            ...
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative">
                                    <img src="<?php echo $URL . $row[10]; ?>" style="width:300px;height: 250px;"></a>
