...
<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/kidsbanner.jpg);">
    ...
    <p class="m-text13 t-center">
        New Arrivals Kids Braclete Collection 2018
    </p>
</section>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                <div class="leftbar p-r-20 p-r-0-sm">
                    ...
                    <ul class="p-b-54">
                        ...
                        <li class="p-t-4">
                            <a href="kidsring.php" class="s-text13">
                                Rings
                            </a>
                        </li>
            ...
            <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                ...
                <div class="flex-sb-m flex-w p-b-35">
                    <div class="flex-w">
                        ...
                        <div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
                            <select class="selection-2" name="sorting">
                                <option>Price</option>
                                <option>₹100.00 - ₹500.00</a></option>
                                <option>₹500.00 - ₹1000.00</option>
                                <option>₹1000.00 - ₹1500.00</option>
                                <option>₹1500.00 - ₹2000.00</option>
                ...
                <div class="row">
                    ...
                    $query = "SELECT * from product WHERE subcat_id = '25'";
