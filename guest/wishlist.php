                        ...
                        <tr class='table-row'>
                            <td class='column-1'>
                                <a href="cart.php?action=delete&p_id=<?php echo $values["item_id"]; ?>"><img
                                            ...
                                            style="width:80px;height: 100px;" title="Remove"></a>
                            </td>
        ...
        <div class="flex-w flex-sb-m p-t-25 p-b-25 bo8 p-l-35 p-r-60 p-lr-15-sm">
            <div class="flex-w flex-m w-full-sm">
                ...
                <div class="size12 trans-0-4 m-t-10 m-b-10 m-r-10">
                    <!-- Button -->
                    <a href="cart.php?action=update&qty=<?php echo $qty = $values["item_quntity"]; ?>"
                       class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="update">Update</a>
