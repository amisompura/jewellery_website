            ...
            <div class="wrap-table-shopping-cart bgwhite">
                <table class="table-shopping-cart">
                    <tr class="table-head">
                        ...
                        <th class="items">Quntity</th>
                        <th class="price">Price</th>
                        <th class="quntity">Total</th>
                    ...
                    <tr>
                        ...
                        $query = "SELECT p.* FROM cart as c LEFT JOIN product as p ON c.p_id = p.p_id";
                    ...
                    <tr class='table-row'>
                        ...
                        ?>
                        <td class='column-1'>
                            <img src="'.$row[10].'" style="width:80px;height: 100px;"></a>
                        </td>
                        <td class='column-2'>'.$row['p_name'].'</td>
                        <td class="column-2">'.$row['qty'].'</td>
                        <td class="column-3">'.$row['price'].'</td>
                        <!-- <td class="column-3">Rs.<?php echo number_format($row['qty'] * $row['price']); ?></td> -->
                    </tr>
                    <?php
